...
import { Radio, QrCode, Copy, RefreshCw, Plus, Trash2, Settings, Shield, Globe, Zap, Save, AlertTriangle, Eye, EyeOff, Star } from 'lucide-react'
...
export default function ChannelSettings({ channels, onUpdateChannel, onCreateChannel, onDeleteChannel }: ChannelSettingsProps) {
  ...
  const [addForm, setAddForm] = useState({
    name: '',
    psk: '',
    modemPreset: 'LongFast' as ModemPreset,
