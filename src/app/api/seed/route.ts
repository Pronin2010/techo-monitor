    ...
    if (existingPresets === 0) {
      await db.preset.createMany({
        data: [
          {
            name: 'Трекер лес 12ч',
            description: 'Максимальное обновление позиции, без сна, полная mesh-участие. Автономность ~12-15 часов на 1000 мАч.',
            icon: '🌲',
            role: 'TRACKER',
          ...
          },
          {
            ...
            description: 'Экономия батареи с циклом сон/бодрствование. Позиция каждые 5 мин. Автономность ~5 дней на 1000 мАч.',
            icon: '🔋',
            role: 'TRACKER',
            nodeInfoBroadcastSecs: 900,
            powerSaving: true,
          ...
          },
          {
            ...
            description: 'Всегда бодрствует, ретранслирует все пакеты, приоритет маршрутизации. Внешнее питание.',
            icon: '🏗️',
            role: 'ROUTER',
          ...
          },
          {
            ...
            description: 'Стандартный узел с экраном, ретранслирует пакеты. Подходит для ручного использования.',
            icon: '📱',
            role: 'CLIENT',
            nodeInfoBroadcastSecs: 900,
            powerSaving: false,
