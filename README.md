...
Веб-приложение для мониторинга, настройки и управления Mesh-сетью на базе T-Echo устройств с прошивкой Meshtastic. Обеспечивает визуализацию топологии сети, управление каналами и пресетами, а также потоковый просмотр пакетов в реальном времени.
...
| **Пресеты** | Готовые и пользовательские пресеты конфигурации для быстрого развёртывания |
...
│       └── meshtastic/           # API синхронизации и скриптов
├── components/
