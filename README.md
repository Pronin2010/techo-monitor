...
| Вкладка | Описание |
|---------|----------|
| **Статус** | Сводная информация об узлах сети: заряд батареи, SNR, RSSI, время последнего отклика. Офлайн-статус определяется автоматически после 15 минут отсутствия пакетов |
